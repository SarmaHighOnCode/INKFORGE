...
async def list_styles() -> list[StylePreset]:
    ...
    return [
        StylePreset(id="neat_cursive", name="Neat Cursive", description="Elegant, connected cursive."),
        ...
        StylePreset(id="doctors_scrawl", name="Doctor's Scrawl", description="Barely legible scribbles."),
        StylePreset(id="elegant_formal", name="Elegant Formal", description="Calligraphy-style writing."),
    ]
